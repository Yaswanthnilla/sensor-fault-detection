#IN CONFIG_ENTITY WE JUST PREPARING THE PATH FOR THE FOLDERS
...
class ModelEvaluationConfig:
    ...
    def __init__(self,training_pipeling_config:TrainingPipelineConfig):
        self.model_evaluation_dir=os.path.join(training_pipeling_config.artifact_dir,training_pipeline.MODEL_EVALUATION_DIR_NAME)
        self.report_file_path=os.path.join(self.model_evaluation_dir,training_pipeline.MODEL_EVALUATION_REPORT_NAME)
        self.model_eval_thershold=training_pipeline.MODEL_EVALUATION_THRESHOLD_SCORE
...
class ModelPusherConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.model_pusher_file_path = os.path.join(self.model_pusher_dir,training_pipeline.MODEL_FILE_NAME)
        timestamp = round(datetime.now().timestamp())
        self.saved_models_file_path=os.path.join(
